<div id="home" class="subpage">
    ...
    <div class="desktop-new-tweet">
        ...
        <div class="tweet-input">
            <form enctype="multipart/form-data" onsubmit="tweet(); return false" >
                <textarea oninput="enableTweetBtn()" onfocus="showTweetVisibility()" class="tweet-input-content" name="tweetContent" rows="1" placeholder="What's happening?"></textarea>
    ...
    <button id="mobile-tweet-btn" onclick="openModal('.mobile-tweet-modal'); return false">
    ...
    <div class="mobile-tweet-modal">

        <div class="modal-container">
        
            <div class="cross-modal" onclick="closeModal('.mobile-tweet-modal')"> 
                ...
                <div class="tweet-input">
                    <form enctype="multipart/form-data" onsubmit="tweet(); return false" >
                        ...
                        <div class="new-tweet-action">
                            ...
                            <button onclick="closeModal('.mobile-tweet-modal')" disabled>Tweet</button>
                        </div>
                        <p class="error-message"></p>
                    </form>
                </div>
