<div id="right">
    ...
    <div class="search-bar">
        <form onsubmit="return false">
            <div>
                ...
                <input class="search-input" onfocus="showSearchResults()" onblur="hideSearchResults()"  oninput="startSearch(); return false" type="search" placeholder="Search Twitter">
            </div>
        </form>
    ...
    <div class="trends">
        ...
        <div class="trend-container">
            ...
            <p class="trend-keyword">Trumps</p>
            <p class="nb-tweets">320K Tweets</p>
        </div>
    ...
    <div class="suggestions">
        ...
        <div class="show-more-suggestions">
            <p>Show More</p>
        </div>
