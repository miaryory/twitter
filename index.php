    ...
    <div id="landing" class="landing-subpage">
        ...
        <div id="landing-right">
            <div class="landing-right-wrapper">
                ...
                <h1>See what's currently happening in the world right now</h1>
                <h2>Join Twitter today.</h2>
                <button onclick="openModal('.signup-modal')">Sign up</button>
                <button onclick="window.location.href='/login.php'" class="secondary-btn">Log in</button>
            </div>
        </div>
